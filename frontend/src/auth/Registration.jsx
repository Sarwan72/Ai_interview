...
const Registration = ({ setIsLogin }) => {
  ...
  return (
    <form className="space-y-4">
      ...
      <div className="flex flex-col w-full">
  <label className="mb-1 text-gray-500">Role</label>

  <select
    value={role}
    onChange={(e) => setRole(e.target.value)}
    //  placeholder="role"
    className="w-full p-2 border border-gray-600 rounded-lg outline-none transition duration-200 hover:border-[#76a988] focus:border-[#6bcc8d] focus:ring focus:ring-[#4DC3AB]"
  >
